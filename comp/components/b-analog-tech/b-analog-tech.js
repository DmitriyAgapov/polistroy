    ...
    $(document).ready(function(){
        ...
        $(document).on('mouseenter', '.b-instock .item-unit-teaser-1', function(e){
            ...
            blockShadow
                ...
                .addClass('active')
                .attr('href', $(this).find('.item-unit-teaser-1__link').attr('href'));
        });
        ...
        function paramsSlider(slidesPerView, slidesPerGroup, loop, loopFillGroupWithBlank, dynamicBullets, freeMode, freeModeMomentum) {
            var options = {
                ...
                navigation: {
                    nextEl: '.b-analog-tech .arrows__next',
                    prevEl: '.b-analog-tech .arrows__prev',
                    disabledClass: 'arrows__arrow_disabled',
                },
                pagination: {
                    el: '.b-analog-tech .b__dots',
                    clickable: true,
            ...
            var swiper_instock = new Swiper('.b-analog-tech .b__list', options);
